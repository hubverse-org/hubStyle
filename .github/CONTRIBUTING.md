# Contributing to hubStyle

This outlines how to propose a change to `hubStyle`. 
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("Infectious-Disease-Modeling-Hubs/hubStyle", fork = TRUE)`.
...
Please note that the hubStyle project is released with a
