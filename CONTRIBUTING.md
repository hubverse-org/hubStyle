...
This outlines how to propose a change to `hubStyle`. For more general
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hubverse-org/hubStyle", fork = TRUE)`.
...
Please note that the hubStyle project is released with a [Contributor
